...
const en: Dict = {
  ...
  "dashboard.subscriberGrowth": "Subscriber Growth — last 6 months",
  "dashboard.networkUsage": "Network Usage",
  "dashboard.networkUsagePlaceholder": "Live network usage will appear here once MikroTik API integration is connected.",
  ...
  "dashboard.newPackage": "New Package",
  "dashboard.newInvoice": "New Invoice",
  "dashboard.createCard": "Create Hotspot Card",
  "dashboard.addRouter": "Add Router",
  ...
  "payments.f.invoice": "Link to Invoice",
  ...
  // Hotspot
  "hotspot.title": "Hotspot Cards",
  "hotspot.subtitle": "Generate and manage hotspot voucher cards.",
  "hotspot.activeSessions": "Active Sessions",
  "hotspot.vouchers": "Vouchers",
  "hotspot.empty": "No hotspot cards yet. Generate some!",
  ...
  "complaints.f.technicianNotes": "Technician Notes",
  "complaints.f.technicianNotesPlaceholder": "Internal notes for the technician…",
  ...
  "settings.f.supportPhone": "Support Phone",
  "settings.f.whatsapp": "WhatsApp Number",
  "settings.f.defaultLanguage": "Default Language",
...
const ar: Dict = {
  ...
  "dashboard.subscriberGrowth": "نمو المشتركين — آخر 6 أشهر",
  "dashboard.networkUsage": "استخدام الشبكة",
  "dashboard.networkUsagePlaceholder": "سيظهر استخدام الشبكة المباشر هنا بعد ربط واجهة MikroTik API.",
  ...
  "dashboard.newSubscriber": "مشترك جديد",
  "dashboard.newPackage": "باقة جديدة",
  "dashboard.newInvoice": "فاتورة جديدة",
  "dashboard.createCard": "إنشاء بطاقة هوت سبوت",
  "dashboard.addRouter": "إضافة راوتر",
  ...
  "payments.f.invoice": "ربط بفاتورة",
  ...
  "hotspot.title": "بطاقات الهوت سبوت",
  "hotspot.subtitle": "إنشاء وإدارة بطاقات هوت سبوت.",
  "hotspot.activeSessions": "الجلسات النشطة",
  "hotspot.vouchers": "البطاقات",
  "hotspot.empty": "لا توجد بطاقات بعد. أنشئ بعضها!",
  ...
  "complaints.f.technicianNotes": "ملاحظات الفني",
  "complaints.f.technicianNotesPlaceholder": "ملاحظات داخلية للفني…",
  ...
  "settings.f.supportPhone": "هاتف الدعم",
  "settings.f.whatsapp": "رقم واتساب",
  "settings.f.defaultLanguage": "اللغة الافتراضية",
